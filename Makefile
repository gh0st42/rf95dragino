...
CC            = g++
CFLAGS        = -DRASPBERRY_PI -DBCM2835_NO_DELAY_COMPATIBILITY -D__BASEFILE__=\"$*\" -DDESKTOP -DRFM95_CS=22 -DRFM95_INT=7 -DRFM95_RST=11 -DBOARD_DRAGINO_PIHAT
LIBS          = -lbcm2835
RADIOHEADBASE = lib/radiohead
RF95MODEMBASE = lib/rf95modem/src
INCLUDE       = -I$(RADIOHEADBASE) -I$(RADIOHEADBASE)/examples/raspi -Ilib/piduino_stripped -I$(RF95MODEMBASE)
...
rf95modem: 		main.o         RH_RF95.o RasPi.o RHHardwareSPI.o RHGenericDriver.o RHGenericSPI.o RHSPIDriver.o piduino_string.o modem.o
				$(CC) $^ $(LIBS) -o rf95modem
